export const painting_names = {
  data: [
    ...
    ["EdouardManet-Olympia_Museed_Orsay_Paris-131x190CM--1863"],
    ["August-Macke-Woman-in-a-Green-Jacket"],
    ["Caravaggio-Michelangelo-Merisi-Narcissus"],
    ["Caspar-David-Friedrich-The-Sea-of-Ice"],
    ["Claude-Monet-Grainstack-in-the-Morning-Snow-Effect"],
    ["Claude-Monet-Water-Lilies"],
    ["Claude_Monet-Gare_Saint_Lazare_Pari"],
    ["Diego-Rodriguez-De-Silva-Y-Vel-zquez-Las-Meninas-detail-3"],
    ["Edouard-Manet-A-Bar-at-the-Folies-Bergere"],
    ["Edvard-Munch---close-to-reads-died-fever---1915-"],
    ["Edvard-Munch-The-Scream"],
    ["EdvardMunch-Melancholy"],
    ["Emile_Nolde-The_Mocking_of_Christ"],
    ["Ernst-Ludwig-Kirchner-Five-Bathing-Women-at-a-Lake"],
    ["Francisco-Jose-De-Goya-Y-Lucientes-The-Third-of-May-1808-Exe"],
    ["Francisco_De_Goya-Saturn_Devouring_His_Son"],
    ["Frida-Kahlo-Self-Portrait-with-Monkeys"],
    ["Georges-Braque-Mandola"],
    ["Georges-Seurat-A-Sunday-Afternoon-on-the-Island-of-La-Grande"],
    ["Georgios-Jakobides-First-Steps"],
    ["Giuseppe-Arcimboldo-Vortumnus-Vertumno"],
    ["Grant-Wood-American-Gothic"],
    ["Gustav-Klimt-The-Kiss-Bacio"],
    ["Gustav_Klimt-Portrait_of_Adele_Bloch-Bauer_I"],
    ["Gustave-Caillebotte-Man-at-the-Window"],
    ["Gustave-Caillebotte-Paris-street-Rainy-Day--2-"],
    ...
    ["Jean-Antoine-Watteau-Gilles-2"],
    ["Jean_Joseph_Benjamin_Constant-The_Throne_Room_In_Byzantium"],
    ["Joan-Miro-Ciphers-and-Constellations-in-Love-with-a-Woman"],
    ["Joan-Miro-Joan-Mir-Catalan-Landscape-The-Hunter"],
    ...
    ["Pablo-Picasso-A-boy-with-pipe"],
    ["Pablo-Picasso-Guernica"],
    ["Pablo-Picasso-Portrait-of-Ambroise-Vollard"],
    ["Pablo-Picasso-Portrait-of-Daniel-Henry-Kahnweiler"],
    ["Pablo-Picasso-Portrait-of-Maya-with-her-doll"],
    ["Pablo-Picasso-The-Young-Ladies-of-Avignon"],
    ["Pablo-Picasso-Women-of-Algiers-Version-O"],
    ["Paul-Cezanne-The-Card-Players-4"],
    ["Paul-Gauguin-Nafeaffaa-Ipolpo-also-known-as-When-Will-You-Ma"],
    ["PaulCezanne-thecardplayers-1892"],
    ["Pavel-Filonov-Peasant-Family"],
    ["Pierre-Auguste-Renoir-Dance-at-Moulin-de-la-Galette"],
    ["Pierre-auguste-Renoir-The-Great-Bathers-The-Nymphs"],
    ["Pieter-Bruegel-The-Younger-The-Battle-between-Lent-and-Carni"],
    ["Raphael-The-School-of-Athens-detail-1-Stanza-della-Segnatura"],
    ["Rembrandt_Van_Rijn-Night_Watch_"],
    ["Rene-Magritte---False-Mirror"],
    ["Rene-Magritte-The-Menaced-Assassin"],
    ["Rene-Magritte-The-Son-of-Man"],
    ["Rene-Magritte-The-meaning-of-night"],
    ["Rene-Magritte-The-seductive"],
    ["Rene-Magritte-Time-transfixed"],
    ["Robert-Delaunay-The-City-of-Paris"],
    ["Rose-Maynard-Barton-The-Dream"],
    ...
    ["Vincent-Van-Gogh-The-Street-the-Yellow-House"],
    ["Vincent-Van-Gogh-Vincent-s-Bedroom-in-Arles-First-version"],
    ["Wassily-Wassilyevich-Kandinsky-Improvisation--Gorge"],
  ],
  famous: [
    ["Jan-Vermeer-The-Girl-with-a-Pearl-Earring"],
    ["August-Macke-Woman-in-a-Green-Jacket"],
